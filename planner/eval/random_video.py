...
if __name__ == "__main__":
    params = get_data_random(
        20, map_res=8, map_fill_perc=20, agent_n=4, job_n=4, idle_goals_n=0
    )
    ...
    (tcbs_paths, tcbs_agent_job, minlp_paths, minlp_agent_job, agent_pos, jobs) = (
        [
            ...
            (
                [(3, 0, 0), (3, 1, 1), (2, 1, 2)],
                [(2, 1, 3), (2, 2, 4), (1, 2, 5), (1, 3, 6), (0, 3, 7), (0, 4, 8)],
        ...
        [
            ...
            (
                [(3, 1, 0), (2, 1, 1)],
                [(2, 1, 2), (2, 2, 3), (1, 2, 4), (1, 3, 5), (0, 3, 6), (0, 4, 7)],
                [(0, 4, 8), (0, 4, 9), (0, 4, 10), (0, 4, 12), (0, 4, 13), (0, 4, 14)],
            ),
            (
                [(4, 4, 0), (4, 5, 1), (4, 6, 2), (4, 7, 3), (5, 7, 4)],
                [
