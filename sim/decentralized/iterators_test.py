...
class TestIterators(unittest.TestCase):
    def __init__(self, methodName: str = "") -> None:
        ...
        nx.set_node_attributes(self.env_sq_graph, {
            0: (0., 0.),
            1: (0., 1.),
            2: (1., 1.),
            3: (1., 0.),
    ...
    def init_agents(self, g):
        agent_0 = Agent(g, 0, radius=.1)
        agent_1 = Agent(g, 1, radius=.1)
    ...
    def test_when_is_policy_called(self):
        ...
        self.assertEqual(
            get_edge_mock_1.call_args_list[0].args[0][0].path,
            PathMatcher([0, 4, 2]))
        self.assertEqual(
            get_edge_mock_1.call_args_list[0].args[0][1].path,
            PathMatcher([1, 4, 3]))
    ...
    def test_how_is_policy_called(self):
        ...
        self.assertEqual(
            ...
            PathMatcher([1, 1, 4, 3]))
        self.assertEqual(
            get_edge_mock_1.call_args_list[1].args[0][0].path,
            PathMatcher([0, 1, 2]))
        self.assertEqual(
            get_edge_mock_1.call_args_list[1].args[0][1].path,
            PathMatcher([1, 1, 4, 3]))
