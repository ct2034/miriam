...
# roadmap
# RUN apt-get install -y wget sudo cmake libcgal-dev libcgal-qt5-dev libeigen3-dev libmgl-dev mathgl qt5-default libboost-filesystem-dev
...
# sometimes also at /usr/lib/x86_64-linux-gnu/liblapack.so.3
RUN ln -s /usr/lib/liblapack.so.3 /lib/liblapack.so.3gf
# sometimes also at /usr/lib/x86_64-linux-gnu/libblas.so.3
