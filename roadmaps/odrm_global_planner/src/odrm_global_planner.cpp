#include <odrm_global_planner/odrm_global_planner.h>
...
PLUGINLIB_EXPORT_CLASS(odrm_global_planner::OdrmGlobalPlanner, nav_core::BaseGlobalPlanner)

using namespace boost;

namespace odrm_global_planner
{
OdrmGlobalPlanner::OdrmGlobalPlanner()
  : costmap_ros_(NULL), initialized_(false), flann_index(flann::LinearIndexParams())
{
}

OdrmGlobalPlanner::OdrmGlobalPlanner(std::string name, costmap_2d::Costmap2DROS* costmap_ros)
  : costmap_ros_(NULL), initialized_(false), flann_index(flann::LinearIndexParams())
{
  initialize(name, costmap_ros);
}

void OdrmGlobalPlanner::initialize(std::string name, costmap_2d::Costmap2DROS* costmap_ros)
{
  ROS_INFO("intialize");
  ...
  if (!initialized_)
  {
    ...
    ros::NodeHandle nh;
    roadmap_sub_ = nh.subscribe("roadmap", 1, &OdrmGlobalPlanner::roadmapCb, this);
...
double OdrmGlobalPlanner::footprintCost(double x_i, double y_i, double theta_i)
{
  if (!initialized_)
  {
...
float OdrmGlobalPlanner::plan_boost(std::vector<geometry_msgs::PoseStamped>& plan, int start_idx, int goal_idx,
...
double OdrmGlobalPlanner::get_angle(const geometry_msgs::PoseStamped& a, geometry_msgs::PoseStamped& b,
...
bool OdrmGlobalPlanner::makePlan(const geometry_msgs::PoseStamped& start, const geometry_msgs::PoseStamped& goal,
...
void OdrmGlobalPlanner::make_poses_along_plan(std::vector<geometry_msgs::PoseStamped>& in,
...
geometry_msgs::PoseStamped OdrmGlobalPlanner::poseStampedFromPoint(geometry_msgs::Point& p)
{
...
geometry_msgs::PoseStamped OdrmGlobalPlanner::poseStampedFromXY(float x, float y)
{
...
void OdrmGlobalPlanner::roadmapCb(const graph_msgs::GeometryGraph& gg)
{
