...
parser.add_argument("verb", type=str, help="a subcommand", choices=verbs)
parser.add_argument("fname", type=str, help="file to open")
parser.add_argument("-v", dest="version", help="which version to transform to")
parser.add_argument("-o", dest="outfile", type=str, help="which file to write to")
