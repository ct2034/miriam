...
class TestSolvers(unittest.TestCase):
    def test_ecbs_success(self):
        ...
        res = ecbs(
            test_helper.env, test_helper.starts_collision, test_helper.goals_collision
        )
    ...
    def test_ecbs_paths_no_collision(self):
        ...
        test_helper.assert_path_equality(self, test_helper.paths_no_collision, paths)
    ...
    def test_ecbs_invalid(self):
        ...
        self.assertEqual(INVALID, ecbs(test_helper.env, starts_invalid, goals_invalid))
    ...
    def test_ecbs_deadlocks(self):
        ...
        starts_deadlocks = np.array([[0, 0], [0, 1], [0, 2], [1, 1], [2, 2]])
        goals_deadlocks = np.array([[2, 0], [2, 1], [2, 2], [0, 0], [1, 1]])
        self.assertEqual(
            INVALID, ecbs(test_helper.env, starts_deadlocks, goals_deadlocks)
        )
    ...
    def test_indep_collision(self):
        ...
        test_helper.assert_path_equality(self, test_helper.paths_collision_indep, paths)
